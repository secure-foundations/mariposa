...
for i in range(8):
    ...
    exp_command = f"./src/exper_wizard.py manager -e filter --total-parts 12 -s z3_4_13_0 -i {project_dir} --clear"
...
exp_command = f"./src/exper_wizard.py manager -e default --total-parts 12 -s z3_4_13_0 -i {project_dir} --clear"
os.system(exp_command)