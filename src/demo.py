...
def demo6():
	...
	copy_to_iter_dir(dbg.do_edits(edit_ids))
...
def demo6_1():
	...
	# mutation      unsat    unknown    timeout  mean (pass/fail)      std
	# ----------  -------  ---------  ---------  ------------------  -----
	# shuffle          61          0          0  5.45 /  --           0.77
	# rename           61          0          0  6.75 /  --           0.12
	# reseed           61          0          0  6.79 /  --           0.32

	dbg.do_edits(edit_ids)

	# time to unsat: 3.65
	# dbg/mimalloc--segment__segment_span_free.v2.smt2/edits/v16.smt2
