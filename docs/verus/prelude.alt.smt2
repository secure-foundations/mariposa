...
(assert (forall ((x Int)) (! (=> (and (<= 0 x) (< x 4294967296)) (= (char%to_unicode (char%from_unicode x)) x)) :pattern ((char%from_unicode x)) :qid prelude_char_injective :skolemid skolem_prelude_char_injective)))
